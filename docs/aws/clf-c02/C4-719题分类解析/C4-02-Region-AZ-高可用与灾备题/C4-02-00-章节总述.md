...
范围：Region、AZ、Multi-AZ、Multi-Region、HA、DR、RTO/RPO。
...
- [1-Region-AZ-高可用与灾备题、Region-AZ-高可用与灾备题、Region-AZ-高可用与灾备题、Region-AZ-高可用与灾备题、Region-AZ-高可用与灾备题、Region-AZ-高可用与灾备题、Region-AZ-高可用与灾备题](./C4-02-01-Region-AZ-高可用与灾备题-Q186至Q531.md)。
- [2-Region-AZ-高可用与灾备题、Region-AZ-高可用与灾备题、Region-AZ-高可用与灾备题](./C4-02-02-Region-AZ-高可用与灾备题-Q543至Q669.md)。

完成以上内容后，可阅读[本章概述](./C4-02-99-章节概述.md)进行复习。
