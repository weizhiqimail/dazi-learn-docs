...
> 本篇是《C4-20-Organizations-治理-IaC题》的第5个分篇，主要包含：Organizations-治理-IaC题、Organizations-治理-IaC题、Organizations-治理-IaC题、Organizations-治理-IaC题、Organizations-治理-IaC题、Organizations-治理-IaC题、Organizations-治理-IaC题。
...
题库记录的正确选项定位为：AWS Compute Optimizer：根据历史利用率等数据提供资源规格优化建议。
...
这道题先识别的不是某个服务名，而是这些约束：**配置变化与合规、关系数据库高可用**。
