...
> 本篇是《C4-26-CAF-Well-Architected题》的第9个分篇，主要包含：CAF-Well-Architected题、CAF-Well-Architected题、CAF-Well-Architected题、CAF-Well-Architected题、CAF-Well-Architected题、CAF-Well-Architected题。
...
这道题先识别的不是某个服务名，而是这些约束：**可中断低成本计算、工作负载架构评审**。
