---
id: 01-EBS-EFS-FSx与存储对比题-等
sidebar_position: 1
---

# C4-06-EBS-EFS-FSx与存储对比题-EBS-EFS-FSx与存储对比题与EBS-EFS-FSx与存储对比题与EBS-EFS-FSx与存储对比题与EBS-EFS-FSx与存储对比题与EBS-EFS-FSx与存储对比题与EBS-EFS-FSx与存储对比题

> 本篇是《C4-06-EBS-EFS-FSx与存储对比题》的第1个分篇，主要包含：EBS-EFS-FSx与存储对比题、EBS-EFS-FSx与存储对比题、EBS-EFS-FSx与存储对比题、EBS-EFS-FSx与存储对比题、EBS-EFS-FSx与存储对比题、EBS-EFS-FSx与存储对比题。
...
题库记录的正确选项定位为：Amazon FSx：托管专业文件系统家族，覆盖 Windows/高性能等文件工作负载。
...
这道题先识别的不是某个服务名，而是这些约束：**Scalability、File Storage**。
...
Amazon FSx：托管专业文件系统家族，覆盖 Windows/高性能等文件工作负载。
