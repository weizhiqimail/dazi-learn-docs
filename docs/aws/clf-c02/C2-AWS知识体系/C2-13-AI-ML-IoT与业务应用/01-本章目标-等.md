...
# C2-13-AI、ML、IoT-与业务应用-本章目标与Amazon-Rekognition与Amazon-Transcribe与Amazon-Polly与Amazon-Textract与Amazon-Comprehend与Amazon-Translate与Amazon-Lex与Amazon-Kendra与Amazon-SageMaker-AI与Generative-AI-与-Amazon-Q与AWS-IoT-Core与AI-服务快速判断法与GlobalShop-AI-链路与本章最后要形成的判断方式与与后续章节的关系
