---
id: C2-13-01-Amazon-Rekognition与Amazon-Transcribe与Amazon-Polly
sidebar_position: 1
---

# C2-13-01-Amazon-Rekognition与Amazon-Transcribe与Amazon-Polly

> 本篇是《C2-13-AI、ML、IoT-与业务应用》的第1个分篇，主要包含：本章目标、Amazon-Rekognition、Amazon-Transcribe、Amazon-Polly、Amazon-Textract、Amazon-Comprehend、Amazon-Translate、Amazon-Lex、Amazon-Kendra、Amazon-SageMaker-AI、Generative-AI-与-Amazon-Q、AWS-IoT-Core、AI-服务快速判断法、GlobalShop-AI-链路、本章最后要形成的判断方式、与后续章节的关系。

## 1-本章目标

AWS 的 AI/ML 服务不能记成“都是人工智能”。
...
**正式名称：** Amazon Rekognition，中文为： 图像与视频分析服务。
...
**正式名称：** Amazon Transcribe，中文为： 语音转文字服务。
...
**正式名称：** Amazon Textract，中文为： 文档文字与结构提取服务。
...
**正式名称：** Amazon Comprehend，中文为： 自然语言处理 NLP 服务。
...
**正式名称：** Amazon Translate，中文为： 机器翻译服务。
...
**正式名称：** Amazon Lex，中文为： 对话式 AI / Chatbot 构建服务。
...
Lex ≠ Polly/Transcribe：Lex 是对话理解与 Bot。

Polly/Transcribe 是单向语音转换。
...
**正式名称：** Amazon Kendra，中文为： 企业智能搜索服务。
...
Kendra 不是 OpenSearch 的同义词。

Kendra 更偏智能企业知识搜索。

OpenSearch 是通用搜索/分析引擎。
...
**正式名称：** Amazon SageMaker AI，中文为： 托管机器学习平台。
...
SageMaker AI 是 ML Platform。

Rekognition/Polly/Textract 等是开箱即用 AI 服务。
...
项目资料当前把 Amazon Q 列入 AI/ML 范围。

CLF 层级应把它理解为 AWS 的生成式 AI 助手/企业助手产品家族，而不是传统数据库、监控或 IAM 服务。
...
- 本篇梳理了Amazon-Rekognition相关的核心知识、适用场景与判断要点。
- 本篇梳理了Amazon-Transcribe相关的核心知识、适用场景与判断要点。
- 本篇梳理了Amazon-Polly相关的核心知识、适用场景与判断要点。
- 本篇梳理了Amazon-Textract相关的核心知识、适用场景与判断要点。
- 本篇梳理了Amazon-Comprehend相关的核心知识、适用场景与判断要点。
- 本篇梳理了Amazon-Translate相关的核心知识、适用场景与判断要点。
- 本篇梳理了Amazon-Lex相关的核心知识、适用场景与判断要点。
- 本篇梳理了Amazon-Kendra相关的核心知识、适用场景与判断要点。
- 本篇梳理了Amazon-SageMaker-AI相关的核心知识、适用场景与判断要点。
- 本篇梳理了Generative-AI-与-Amazon-Q相关的核心知识、适用场景与判断要点。
- 本篇梳理了AWS-IoT-Core相关的核心知识、适用场景与判断要点。
- 本篇梳理了AI-服务快速判断法相关的核心知识、适用场景与判断要点。
- 本篇梳理了GlobalShop-AI-链路相关的核心知识、适用场景与判断要点。
- 本篇梳理了本章最后要形成的判断方式相关的核心知识、适用场景与判断要点。
- 本篇梳理了与后续章节的关系相关的核心知识、适用场景与判断要点。

[返回本章总述](./C2-13-00-章节总述.md)｜[查看本章概述](./C2-13-99-章节概述.md)
