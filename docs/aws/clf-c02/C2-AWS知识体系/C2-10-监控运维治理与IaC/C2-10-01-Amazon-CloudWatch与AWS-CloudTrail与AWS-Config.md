---
id: C2-10-01-Amazon-CloudWatch与AWS-CloudTrail与AWS-Config
sidebar_position: 1
---

# C2-10-01-Amazon-CloudWatch与AWS-CloudTrail与AWS-Config

> 本篇是《C2-10-监控、运维、治理与-IaC》的第1个分篇，主要包含：本章目标、Amazon-CloudWatch、AWS-CloudTrail、AWS-Config、CloudWatch-CloudTrail-Config-考试最高频三分法、AWS-Systems-Manager、AWS-CloudFormation、Infrastructure-as-Code（IaC）、AWS-Trusted-Advisor、AWS-Compute-Optimizer、AWS-Organizations、AWS-Control-Tower、AWS-Service-Catalog、AWS-Resource-Access-Manager（RAM）、AWS-Health-Service-Health、GlobalShop-运维治理图、本章最后要形成的判断方式、与后续章节的关系。

## 1-本章目标

一个系统部署完成后，真正的长期问题才开始：CPU 高不高？
...
**正式名称：** Amazon CloudWatch，中文为： AWS 监控与可观测性服务。
...
CloudWatch Metrics/Logs/Alarm + Auto Scaling。
...
**正式名称：** AWS CloudTrail，中文为： AWS API 活动审计日志服务。
...
**正式名称：** AWS Config，中文为： AWS 资源配置记录与合规评估。
...
**正式名称：** AWS Systems Manager，中文为： AWS 集中运维管理服务。
...
Systems Manager + EC2 IAM Role/Agent。

Systems Manager + Hybrid nodes。
...
**正式名称：** AWS CloudFormation，中文为： AWS 基础设施即代码 IaC 服务。
...
- 本篇梳理了Amazon-CloudWatch相关的核心知识、适用场景与判断要点。
- 本篇梳理了AWS-CloudTrail相关的核心知识、适用场景与判断要点。
- 本篇梳理了AWS-Config相关的核心知识、适用场景与判断要点。
- 本篇梳理了CloudWatch-CloudTrail-Config-考试最高频三分法相关的核心知识、适用场景与判断要点。
- 本篇梳理了AWS-Systems-Manager相关的核心知识、适用场景与判断要点。
- 本篇梳理了AWS-CloudFormation相关的核心知识、适用场景与判断要点。
- 本篇梳理了Infrastructure-as-Code（IaC）相关的核心知识、适用场景与判断要点。
- 本篇梳理了AWS-Trusted-Advisor相关的核心知识、适用场景与判断要点。
- 本篇梳理了AWS-Compute-Optimizer相关的核心知识、适用场景与判断要点。
- 本篇梳理了AWS-Organizations相关的核心知识、适用场景与判断要点。
- 本篇梳理了AWS-Control-Tower相关的核心知识、适用场景与判断要点。
- 本篇梳理了AWS-Service-Catalog相关的核心知识、适用场景与判断要点。
- 本篇梳理了AWS-Resource-Access-Manager（RAM）相关的核心知识、适用场景与判断要点。
- 本篇梳理了AWS-Health-Service-Health相关的核心知识、适用场景与判断要点。
- 本篇梳理了GlobalShop-运维治理图相关的核心知识、适用场景与判断要点。
- 本篇梳理了本章最后要形成的判断方式相关的核心知识、适用场景与判断要点。
- 本篇梳理了与后续章节的关系相关的核心知识、适用场景与判断要点。

[返回本章总述](./C2-10-00-章节总述.md)｜[查看本章概述](./C2-10-99-章节概述.md)
