---
id: C2-11-01-同步调用的问题-为什么要异步化与Amazon-SQS与Standard-Queue-与-FIFO-Queue
sidebar_position: 1
---

# C2-11-01-同步调用的问题-为什么要异步化与Amazon-SQS与Standard-Queue-与-FIFO-Queue
...
[返回本章总述](./C2-11-00-章节总述.md)｜[查看本章概述](./C2-11-99-章节概述.md)
