---
id: C2-15-01-Cloud-Economics-从-CAPEX-到-OPEX与AWS-Pricing-Calculator与AWS-Cost
sidebar_position: 1
---

# C2-15-01-Cloud-Economics-从-CAPEX-到-OPEX与AWS-Pricing-Calculator与AWS-Cost

> 本篇是《C2-15-成本、计费、定价与-Support》的第1个分篇，主要包含：本章目标、Cloud-Economics-从-CAPEX-到-OPEX、AWS-Pricing-Calculator、AWS-Cost-Explorer、AWS-Budgets、AWS-Cost-and-Usage-Report（CUR）、Tags-与-Cost-Allocation、EC2-Compute-购买模型再统一、Capacity-Reservation、Data-Transfer-Cost-基本规律、AWS-Organizations-与-Consolidated-Billing、Cost-Optimization-的过程、AWS-Support-项目资料中的当前状态提醒-UPDATED、Support-题真正应该理解什么、AWS-Marketplace、GlobalShop-成本管理、高频对比、本章最后要形成的判断方式、与后续章节的关系。

## 1-本章目标

云计算并不是“自动便宜”，而是把成本模型变得更可测量、更弹性。
...
适合：Batch、stateless、fault-tolerant、can retry。

不适合把唯一关键数据库直接放在“随时可中断”的 Spot 上。

### 8.5-★★★-Dedicated-Hosts-/-Dedicated-Instances

用于物理服务器隔离、License / compliance 等特殊需求。

Dedicated Host 提供对底层物理主机更明确的可见性和控制。
...
考试如果说：Need guaranteed EC2 capacity in specific AZ。
...
项目交接资料明确记录：AWS Support 体系在 2025-12-02 后发生调整，旧的 Developer Support、Business Support 等旧套餐已进入不再接受新订阅/过渡阶段，并记录了新的 Support 体系名称：Basic、Business Support + Enterprise Support、Unified Operations。
...
- 本篇梳理了Cloud-Economics-从-CAPEX-到-OPEX相关的核心知识、适用场景与判断要点。
- 本篇梳理了AWS-Pricing-Calculator相关的核心知识、适用场景与判断要点。
- 本篇梳理了AWS-Cost-Explorer相关的核心知识、适用场景与判断要点。
- 本篇梳理了AWS-Budgets相关的核心知识、适用场景与判断要点。
- 本篇梳理了AWS-Cost-and-Usage-Report（CUR）相关的核心知识、适用场景与判断要点。
- 本篇梳理了Tags-与-Cost-Allocation相关的核心知识、适用场景与判断要点。
- 本篇梳理了EC2-Compute-购买模型再统一相关的核心知识、适用场景与判断要点。
- 本篇梳理了Capacity-Reservation相关的核心知识、适用场景与判断要点。
- 本篇梳理了Data-Transfer-Cost-基本规律相关的核心知识、适用场景与判断要点。
- 本篇梳理了AWS-Organizations-与-Consolidated-Billing相关的核心知识、适用场景与判断要点。
- 本篇梳理了Cost-Optimization-的过程相关的核心知识、适用场景与判断要点。
- 本篇梳理了AWS-Support-项目资料中的当前状态提醒-UPDATED相关的核心知识、适用场景与判断要点。
- 本篇梳理了Support-题真正应该理解什么相关的核心知识、适用场景与判断要点。
- 本篇梳理了AWS-Marketplace相关的核心知识、适用场景与判断要点。
- 本篇梳理了GlobalShop-成本管理相关的核心知识、适用场景与判断要点。
- 本篇梳理了高频对比相关的核心知识、适用场景与判断要点。
- 本篇梳理了本章最后要形成的判断方式相关的核心知识、适用场景与判断要点。
- 本篇梳理了与后续章节的关系相关的核心知识、适用场景与判断要点。

[返回本章总述](./C2-15-00-章节总述.md)｜[查看本章概述](./C2-15-99-章节概述.md)
