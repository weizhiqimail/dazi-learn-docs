...
# C2-15-成本、计费、定价与-Support-本章目标与Cloud-Economics-从-CAPEX-到-OPEX与AWS-Pricing-Calculator与AWS-Cost-Explorer与AWS-Budgets与AWS-Cost-and-Usage-Report（CUR）与Tags-与-Cost-Allocation与EC2-Compute-购买模型再统一与Capacity-Reservation与Data-Transfer-Cost-基本规律与AWS-Organizations-与-Consolidated-Billing与Cost-Optimization-的过程与AWS-Support-项目资料中的当前状态提醒-UPDATED与Support-题真正应该理解什么与AWS-Marketplace与GlobalShop-成本管理与高频对比与本章最后要形成的判断方式与与后续章节的关系
