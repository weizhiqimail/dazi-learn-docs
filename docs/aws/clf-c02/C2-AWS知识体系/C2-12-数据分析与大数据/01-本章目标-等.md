...
# C2-12-数据分析与大数据-本章目标与OLTP-与-Analytics-不是同一种数据库需求与Amazon-Athena与AWS-Glue与Amazon-Kinesis与Amazon-EMR与Amazon-OpenSearch-Service与Amazon-Redshift与Amazon-QuickSight与Data-Lake与AWS-Lake-Formation与Data-Warehouse-vs-Data-Lake与GlobalShop-数据链路与高频选择表与本章最后要形成的判断方式与与后续章节的关系
