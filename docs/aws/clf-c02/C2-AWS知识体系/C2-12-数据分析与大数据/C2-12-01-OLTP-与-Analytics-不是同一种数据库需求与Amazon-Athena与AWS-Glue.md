---
id: C2-12-01-OLTP-与-Analytics-不是同一种数据库需求与Amazon-Athena与AWS-Glue
sidebar_position: 1
---

# C2-12-01-OLTP-与-Analytics-不是同一种数据库需求与Amazon-Athena与AWS-Glue

> 本篇是《C2-12-数据分析与大数据》的第1个分篇，主要包含：本章目标、OLTP-与-Analytics-不是同一种数据库需求、Amazon-Athena、AWS-Glue、Amazon-Kinesis、Amazon-EMR、Amazon-OpenSearch-Service、Amazon-Redshift、Amazon-QuickSight、Data-Lake、AWS-Lake-Formation、Data-Warehouse-vs-Data-Lake、GlobalShop-数据链路、高频选择表、本章最后要形成的判断方式、与后续章节的关系。

## 1-本章目标

业务系统数据库解决的是“交易怎么正确完成”，但企业还会问：昨天有多少用户？
...
**正式名称：** Amazon Athena，中文为： Serverless 交互式查询服务。
...
Athena results → S3/BI tools。

### 3.5-容易混淆

Athena ≠ Redshift：Athena 直接查询 S3、按查询模式。
...
**正式名称：** AWS Glue，中文为： Serverless 数据集成与 ETL 服务。
...
**正式名称：** Amazon Kinesis，中文为： 实时流数据处理服务家族。
...
Kinesis 提供实时数据流采集与处理相关服务能力。

CLF 重点理解 Streaming，而不是深入 shard 配置。
...
App → Kinesis → Lambda/Analytics/S3。

Streaming pipeline。

### 5.5-容易混淆

Kinesis ≠ SQS：Kinesis 是流式数据处理平台。
...
**正式名称：** Amazon Elastic MapReduce，中文为： 托管大数据处理平台。
...
EMR output → S3/Redshift。

### 6.5-容易混淆

EMR ≠ Glue：两者都可处理数据，但 EMR 更偏开源大数据框架与可控计算环境。

Glue 更偏 Serverless 数据集成/ETL。
...
**正式名称：** Amazon OpenSearch Service，中文为： 托管搜索与日志分析服务。
...
OpenSearch ≠ CloudWatch：CloudWatch 是监控平台。

OpenSearch 是搜索/分析引擎，两者可处理部分相邻日志场景但定位不同。
...
**正式名称：** Amazon Redshift，中文为： 云数据仓库。
...
Redshift 是 AWS 托管云数据仓库服务，用于大规模分析。

项目题库中 Redshift 粗略曝光约 18 次。
...
Redshift ≠ RDS：RDS 偏 OLTP 关系数据库。

Redshift 偏 OLAP/Data Warehouse。
...
**正式名称：** Amazon QuickSight，中文为： Serverless BI 服务。
...
- 本篇梳理了OLTP-与-Analytics-不是同一种数据库需求相关的核心知识、适用场景与判断要点。
- 本篇梳理了Amazon-Athena相关的核心知识、适用场景与判断要点。
- 本篇梳理了AWS-Glue相关的核心知识、适用场景与判断要点。
- 本篇梳理了Amazon-Kinesis相关的核心知识、适用场景与判断要点。
- 本篇梳理了Amazon-EMR相关的核心知识、适用场景与判断要点。
- 本篇梳理了Amazon-OpenSearch-Service相关的核心知识、适用场景与判断要点。
- 本篇梳理了Amazon-Redshift相关的核心知识、适用场景与判断要点。
- 本篇梳理了Amazon-QuickSight相关的核心知识、适用场景与判断要点。
- 本篇梳理了Data-Lake相关的核心知识、适用场景与判断要点。
- 本篇梳理了AWS-Lake-Formation相关的核心知识、适用场景与判断要点。
- 本篇梳理了Data-Warehouse-vs-Data-Lake相关的核心知识、适用场景与判断要点。
- 本篇梳理了GlobalShop-数据链路相关的核心知识、适用场景与判断要点。
- 本篇梳理了高频选择表相关的核心知识、适用场景与判断要点。
- 本篇梳理了本章最后要形成的判断方式相关的核心知识、适用场景与判断要点。
- 本篇梳理了与后续章节的关系相关的核心知识、适用场景与判断要点。

[返回本章总述](./C2-12-00-章节总述.md)｜[查看本章概述](./C2-12-99-章节概述.md)
