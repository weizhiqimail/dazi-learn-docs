---
id: C1-07-01-AWS-不是网上租服务器与AWS-的产品是为了解决真实-IT-问题与同一个业务会同时使用大量-AWS-服务
sidebar_position: 1
---

# C1-07-01-AWS-不是网上租服务器与AWS-的产品是为了解决真实-IT-问题与同一个业务会同时使用大量-AWS-服务
...
[返回本章总述](./C1-07-00-章节总述.md)｜[查看本章概述](./C1-07-99-章节概述.md)
