---
id: C1-05-01-为什么-AWS-名字看起来这么乱与缩写型服务与名称中经常出现的-Elastic
sidebar_position: 1
---

# C1-05-01-为什么-AWS-名字看起来这么乱与缩写型服务与名称中经常出现的-Elastic
...
简称：**AZ**，中文为：**可用区**AWS 官方定义一个 AZ 可以由一个或多个独立数据中心组成。
